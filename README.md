...
#### `Engine.Persistence`
Contiene la **lógica pura** de las funciones para manejar la **persistencia del estado del juego**, permitiendo cargar un estado inicial desde un archivo para el modelado del mundo. En persistence se maneja:
